...
class NegativeAmountE2ETest extends AbstractIntegrationTest {
    ...
    @Test
    void shouldSendEventToFailedTopicWhenAmountIsZero() throws ExecutionException, InterruptedException, TimeoutException {
        OrderCreatedEvent event = new OrderCreatedEvent(
                UUID.randomUUID().toString(),
                "ORD-NEG-" + UUID.randomUUID(),
                "USER-NEG",
                BigDecimal.ZERO,
                "RUB",
                Instant.now()
        ...
        failedConsumer = new KafkaTestConsumer<>(
                ...
                "failed-negative-amount-consumer-" + UUID.randomUUID(),
        ...
        assertThat(failedRecord.value().reason()).contains("amount");
